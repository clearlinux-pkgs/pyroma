...
%prep
%setup -q -n pyroma-3.2
cd %{_builddir}/pyroma-3.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636476118
...
cp %{_builddir}/pyroma-3.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/pyroma/b0fc0d8365766fe5b3c0ed32016393c8441272d7
