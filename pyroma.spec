...
Version  : 3.0.1
Release  : 18
URL      : https://files.pythonhosted.org/packages/cc/cb/7e5cbf1ba448ee8d88ad664df7d5c32c7ef0ed799e3266372a04d9c900e8/pyroma-3.0.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/cc/cb/7e5cbf1ba448ee8d88ad664df7d5c32c7ef0ed799e3266372a04d9c900e8/pyroma-3.0.1.tar.gz
...
%prep
%setup -q -n pyroma-3.0.1
cd %{_builddir}/pyroma-3.0.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1614785581
...
cp %{_builddir}/pyroma-3.0.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/pyroma/b0fc0d8365766fe5b3c0ed32016393c8441272d7
